...
// --- Definition of actors, components and auxiliar entities --- //
...
sig Internship {
    ...
    interruptedBy != none implies selected in interruptedBy.students
}
...
// Feedback about recommendations given to students and companies
sig ReccomendationFeedback extends Feed {
    preference: one Thumb       // User's preference (Up/Down)
}
