...
\subsubsection{Mapping}
    \begin{table}[h]
    \centering
    \begin{tabular}{|m{1cm}|m{4cm}|m{1cm}|m{4cm}|} % Prima colonna piccola, seconda larga
    \hline
    \multicolumn{4}{|c|}{G1:  Allows registered companies to post and advertise the available internships that they offer.} \\ \hline
    R1 & Questa è una descrizione molto lunga che occupa gran parte dello spazio disponibile. & D1 & adam \\ \hline
    R2 & Un altro testo molto lungo con più dettagli. & D2 & adams \\ \hline
    \end{tabular}
    \label{tab:colonne-dimensioni}
    \end{table}
