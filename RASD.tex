...
% GENERAL LAYOUT
\usepackage{geometry} % To set uniform margins
\geometry{
  left=0.8in,
  right=0.8in,
  top=1in,
...
\usepackage{parskip} % For paragraph layout (removes indentation between paragraphs)
\setlength\parindent{0pt} % Removes paragraph indentation
\raggedbottom % Prevents extra vertical stretching of pages
\usepackage{setspace} % For single or double spacing
\usepackage{emptypage} % To handle empty pages gracefully

% MULTI-COLUMN LAYOUT
\usepackage{multicol} % For writing in multiple columns
\setlength\columnsep{15pt} % Column separation in multi-column environments

%----------------------------------------------------------------------------
%	PACKAGES FOR TITLES AND SPACING
%----------------------------------------------------------------------------
\usepackage{titlesec} % Customizing title and section spacing
...
\usepackage[11pt]{moresize} % Enables larger font sizes

%----------------------------------------------------------------------------
%	PACKAGES FOR IMAGES AND FIGURES
%----------------------------------------------------------------------------
\usepackage{graphicx} % For including images
\graphicspath{{./Images/}} % Sets default directory for images
...
\usetikzlibrary{} % Load TikZ libraries as needed
\usepackage{caption} % Customizable captions for figures
\usepackage{float} % For fixing figure/table positions
...
\usepackage{amsfonts} % Additional fonts for math
\usepackage{bm} % Bold math symbols
\usepackage[overload]{empheq} % For systems of equations with braced-style notation
\usepackage{fix-cm} % Overrides LaTeX restrictions on font sizes

%----------------------------------------------------------------------------
%	PACKAGES FOR TABLES
%----------------------------------------------------------------------------
\usepackage{tabularx} % Tables with adjustable-width columns
\usepackage{xltabular} % Extended functionality for tabularx
\usepackage{booktabs} % Professional-quality tables
\usepackage{longtable} % Tables that span multiple pages
\usepackage{colortbl} % For colored tables
\usepackage{array} % Extended table functionality
\renewcommand{\arraystretch}{1.5} % Extra vertical spacing in tables
\newcolumntype{C}[1]{>{\centering\arraybackslash}m{#1}} % Centered column type

%----------------------------------------------------------------------------
%	PACKAGES FOR LISTINGS AND ALGORITHMS
%----------------------------------------------------------------------------
...
\usepackage{algorithm} % For pseudocode environments
\usepackage{algorithmic} % Algorithmic commands for pseudocode
...
\usepackage[colorlinks=true,
            ...
            menucolor=black,
            runcolor=black,
            urlcolor=black]{hyperref} % Clickable links in references
\usepackage{cleveref} % Enhanced referencing
\usepackage[square, numbers, sort&compress]{natbib} % Citation styles
\bibliographystyle{abbrvnat} % Bibliography style (choose one suited to your field)
...
\usepackage{afterpage} % Commands to be executed after a page break
\usepackage{lipsum} % Dummy text for testing/documentation
...
\newcommand{\e}[1]{\times 10^{#1}} % Shortcut for scientific notation
...
\begin{tabularx}{\textwidth}{llX}
    ...
    \midrule
    07-Jan-2025 & 2.0 & Figures modification, Use Case diagram integration \\
    \bottomrule
\end{tabularx}
\vspace{0.33pt}
...
\begin{xltabular}{\textwidth}{| l | X |}
\toprule
\multicolumn{2}{|c|}{UserWritesObservation}\\
\toprule
...
\begin{center}
    \begin{tabular}{|C{3cm}|p{10cm}|}
    \hline
    \multicolumn{2}{|c|}{\parbox{13cm}{G6: Allows a registered company to view the list of all the students who applied to one of its advertised internships.}} \\
    \hline
    \centering R1 & The system must allow a student who wants to register to sign up. \\ 
    \hline
    \centering R2 & The system must allow a company who wants to register to sign up. \\
...
\begin{center}
    \begin{tabular}{|C{3cm}|p{10cm}|}
    \hline
    \multicolumn{2}{|c|}{\parbox{13cm}{G9: Allows a registered university to view the comments about an ongoing internship, written either by its interning students or by the host company.}} \\
    \hline
    \centering R3 & The system must allow a university who wants to register to sign up. \\ 
    \hline
    \centering R4 & The system must allow registered users to sign in using their credentials. \\ 
