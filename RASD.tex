...
The system should integrate a NoticationService to keep up Users of any interesting event on
the platform, an EmailService for the registration process, and a proper University Dictionary to assure the university existance.
