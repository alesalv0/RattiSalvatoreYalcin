...
This diagram is presented as a continuation of the scenario shown in Figure 19. In summary, the company has accessed the advertisements they previously shared and navigated to the desired advertisement cell. In this scenario, we assumed that the company selects a student's profile from the "All Candidates" list via the interface. The system retrieves data using the student class, which includes various parameters such as studentId and studentInfo, from the database. At the end of the scenario, the system displays the updated list on the company page, reflecting the changes with the revised list.
\begin{figure}[H]
    \centering
    \includegraphics[scale = 0.22]{DD_figures/RuntimeView/companyViewStudentDetails.drawio.png}
...
\begin{figure}[H]
\centering
\includegraphics[scale = 0.20]{DD_figures/RuntimeView/studentConfirmCompany.drawio.png}
...
\subsubsection*{POST api/student/\{studentId\}/uploadCV}
\begin{description}
...
\begin{description}
    \item[Request Body:] response: boolean, userId: int
    \item[200 Response:] message: String("Success") 
    \item[500 Response:] error : String("Server side error")
\end{description}

\subsubsection*{POST api/internship/\{internshipId\}/response}
\begin{description}
    \item[Request Body:] student: Object, response: boolean
    \item[200 Response:] message: String("Success") 
    \item[500 Response:] error : String("Server side error")
\end{description}

\subsubsection*{POST api/internship/\{internshipId\}/recommendationFeedback}
\begin{description}
    \item[Request Body:] feedback: Object, userId: int
    \item[200 Response:] message: String("Success") 
...
\subsubsection*{POST api/internships/\{internshipId\}/acceptRecommendation}
\begin{description}
    \item[Request Body:] studentId: int, isStudent: boolean
    \item[200 Response:] comments: Array of Object 
    \item[400 Response:] error : String("Invalid internshipId")
\end{description}

\subsubsection*{GET api/internship/\{internshipId\}/studentProfile}
\begin{description}
    \item[200 Response:] studentProfile: Object
    \item[400 Response:] error : String("Invalid data")
\end{description}

\subsubsection*{GET api/user/\{userId\}/comments}
\begin{description}
    \item[Request Body:]  internshipId: int
    \item[200 Response:] comments: Array of Object 
    \item[400 Response:] error : String("Invalid internshipId")
\end{description}
\subsubsection*{POST api/user/\{userId\}/observation}
\begin{description}
    \item[Request Body:] observation: Object, internshipId: int
    \item[200 Response:] message: String("Success") 
    \item[400 Response:] error : String("Invalid internshipId")
\end{description}

\subsubsection*{POST api/user/\{userId\}/complaint}
\begin{description}
    \item[Request Body:] complaint: Object, internshipId: int
    \item[200 Response:] message: String("Success") 
    \item[400 Response:] error : String("Invalid internshipId")
\end{description}
\subsubsection*{GET api/user/\{userId\}/complaints}
\begin{description}
    \item[Request Body:] complaints: Array of Object, internshipId: int
    \item[200 Response:] message: String("Success") 
    \item[400 Response:] error : String("Invalid internshipId")
\end{description}

\subsubsection*{GET api/user/\{userId\}/observations}
\begin{description}
    \item[Request Body:] observations: Array of Object, internshipId: int
    \item[200 Response:] message: String("Success") 
    \item[400 Response:] error : String("Invalid internshipId")
\end{description}
