...
\begin{itemize}
  ...
  \item \textbf{G6}Allows a company the candidates for one of its offered  and only after manage* their selection process. 
...
The system also wants to have some connection with the universities, so a service for that is needed.
