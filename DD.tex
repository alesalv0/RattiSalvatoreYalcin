...
\begin{description}
    ...
    \item[201 Response:] Created
    \item[400 Response:] validationError : Object
\end{description}

\begin{description}
    \item[Request Body:] User: Object 
    \item[200 Response:] Username, token : Object
    \item[400 Response:] validationError : Object 
    \item[401 Response:] loginError : Object
\end{description}
...
In this section, three distinct primary interfaces are designed based on the user types (university, student, and company). The system is intended to operate on any desktop or mobile browser capable of facilitating interaction with the user. Furthermore, this section will present detailed explanations of the interface mockups, illustrating the system's operational flow and the core functionalities that will interact with the user.

\subsubsection*{Entrance Page}
This page is presented to the user as the welcoming page upon their initial login to the system.
\begin{figure}[H]
    \centering
    ...
    \centering
\end{figure}
\subsubsection*{Home Sign Up Page}
This page presents a primary sign-up interface, allowing the user to make selections based on their user type. Company users are required to proceed by selecting the appropriate sign-up page for companies within the interface. Furthermore, students or university representatives (e.g., career services) are expected to make their selection from the list of institutions provided by the National Education Dictionary API.
\begin{figure}[H]
    \centering
...
\subsubsection*{Student Sign Up and Upload CV Pages}
We assumed that on this page, the student is required to provide their university email and set a password during the registration process. After completing the registration part, the system expects to upload an up-to-date CV from the students to complete their profile. Once both pages in the interface are filled out, the system finalizes the student's registration process.
\begin{figure}[H]
    \centering
...
\begin{figure}[H]
    ...
    \centering
\end{figure}
\subsubsection*{University Student Sign Up and Upload CV Pages}
\begin{figure}[H]
    \centering
...
Once all the components have been implemented and unit tested, full integration tests with
Drivers and Stubs for external services are done. As the last step, integration tests with the
