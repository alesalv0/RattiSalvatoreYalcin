...
This diagram illustrates the scenario in which students utilize the system’s homepage interface to list general internship advertisements and view their details. 
\begin{figure}[H]
    \centering
...
The diagram below shows the process of a User (either student or company) accepting a recommendation proposed by the platform algorithm. Both studentID and internshipID are needed for the operation.
\begin{figure}[H]
\centering
...
\subsubsection*{GET api/users/\{userId\}/acceptedProposals}
\begin{description}
    \item[200 Response:] acceptedProposals: Array of Objects 
    \item[400 Response:] error : String("Unauthorized")
\end{description}

\subsubsection*{GET api/users/\{userId\}/matchedInternships}
\begin{description}
...
\subsubsection*{POST api/internship/\{internshipId\}/acceptRecommendation}
\begin{description}
...
\subsubsection*{GET api/users/\{userId\}/comments}
\begin{description}
    \item[Request Body:]  internshipId: int
    \item[200 Response:] comments: Array of Object 
    \item[400 Response:] error : String("Invalid internshipId")
\end{description}
\subsubsection*{POST api/users/\{userId\}/observation}
\begin{description}
...
\subsubsection*{POST api/users/\{userId\}/complaint}
\begin{description}
...
\subsubsection*{PUT api/internship/\{internshipId\}/interrupt}
\begin{description}
...
\subsubsection*{GET api/users/\{userId\}/template}
\begin{description}
