...
\begin{itemize}
  ...
  \item \textbf{G5} Allows a registered company to be recommended a list of registered students who might be of interest for one of their advertised internships with respect to: their uploaded CVs, the internship project and users' feedbacks.
  ...
  \item \textbf{G8} Allows the users that are taking part* in an ongoing internship to comment about it.
  \item \textbf{G9} Allows a registered university to view comments about an ongoing internship, written either by its interning students or by the host company.
  \item \textbf{G10} Allows a registered university to interrupt an ongoing internship involving one its students.
  \item \textbf{G11} Allows companies and students to provide feedback about a past internship only if they respectively offered it and took part in it.
...
\begin{figure}[H]
    \centering
    \includegraphics[scale = 0.45]{figures/use_case_1-Student.drawio.png}
    \caption{Student}
    \centering
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[scale = 0.4]{figures/use_case_1-Company.drawio.png}
    \caption{Company}
    \centering
\end{figure}
\begin{figure}[H]
